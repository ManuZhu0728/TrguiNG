    ...
    mutate(
      ...
      },
      {
        onError: (e) => {
          ...
          notifications.show({
            message: t("modals.edit_trackers.error_update"),
            color: "red",
          });
        },
      }
    ...
    <>
      {props.opened && (
        <SaveCancelModal
          ...
          onSave={onSave}
          centered
          title={t("modals.edit_trackers.title")}
          mih="25rem"
        >
          ...
          <Grid align="center">
            ...
            <Grid.Col span={8}>
              <Text>{t("modals.edit_trackers.tracker_list_desc")}</Text>
            </Grid.Col>
            <Grid.Col span={4}>
              <Button onClick={addDefaultTrackers}>
                {t("modals.edit_trackers.add_default_list")}
              </Button>
            </Grid.Col>
            <Grid.Col>
