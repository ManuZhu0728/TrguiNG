        ...
        mutate(
            ...
            },
            {
                onError: (e) => {
                    ...
                    notifications.show({
                        message: t("editTrackers.errorUpdatingTorrent"),
                        color: "red",
                    });
                },
            },
        ...
        <>
            {props.opened && (
                <SaveCancelModal
                    ...
                    onSave={onSave}
                    centered
                    title={t("editTrackers.editTorrentTrackers")}
                    mih="25rem"
                >
                    ...
                    <Grid align="center">
                        ...
                        <Grid.Col span={8}>
                            <Text>{t("editTrackers.trackerListHint")}</Text>
                        </Grid.Col>
                        <Grid.Col span={4}>
                            <Button onClick={addDefaultTrackers}>
                                {t("editTrackers.addDefaultList")}
                            </Button>
                        </Grid.Col>
                        <Grid.Col>
