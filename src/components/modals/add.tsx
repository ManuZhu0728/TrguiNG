...
function AddCommon(props: AddCommonProps) {
  ...
  return (
    <>
      <TorrentLocation
        {...props.location}
        inputLabel={t("modals.add.downloadDirectory")}
  ...
  const addMutation = useAddTorrent(
    useCallback(
      ...
      (response: any) => {
        ...
        if (duplicate !== undefined) {
          notifications.show({
            title: t("modals.add.torrentAlreadyExists"),
        ...
        if (added !== undefined) {
          notifications.show({
            title: t("modals.add.torrentAdded"),
            message: added.name,
            color: "green",
          });
        }
    ...
    useCallback(
      (e) => {
        ...
        notifications.show({
          title: t("modals.add.errorAddingTorrent"),
          message: String(e),
          color: "red",
        });
      },
        ...
        <HkModal
          ...
          title={
            <Flex w="100%" align="center" justify="space-between">
              <span>{t("modals.add.addByMagnet")}</span>
          ...
          <TextInput
            ...
            error={
              existingTorrent === undefined
                ? undefined
                : t("modals.add.torrentAlreadyExists")
            }
            autoComplete="off"
            autoCorrect="off"
            autoCapitalize="off"
  ...
  useEffect(() => {
    if (TAURI && props.opened && torrentData === undefined) {
      ...
      pathPromise
        ...
        .catch((e) => {
          notifications.show({
            title: t("modals.add.errorReadingTorrent"),
            message: String(e),
            color: "red",
          });
          props.close();
    ...
    if (!TAURI && props.opened) {
      if (props.uri === undefined) {
        ...
        readLocalTorrent(file)
          ...
          .catch(() => {
            notifications.show({
              title: t("modals.add.errorReadingFile"),
              message: file.name,
              color: "red",
            });
            close();
        ...
        <HkModal
          ...
          title={
            <Flex w="100%" align="center">
              <span>{t("modals.add.addTorrent")}</span>
              <Box sx={{ flexGrow: 1 }} />
              {TAURI && (
                <>
            ...
            {torrentData.length > 1 || torrentData[0].files == null ? (
              ...
              <>
                <Button
                  ...
                  title={t("modals.add.markAllWanted")}
                >
                  {t("modals.add.all")}
                </Button>
                <Button
                  ...
                  title={t("modals.add.markAllUnwanted")}
                >
                  {t("modals.add.none")}
                </Button>
              </>
