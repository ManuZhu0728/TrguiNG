    ...
    mutate(
      ...
      },
      {
        onError: (e) => {
          ...
          notifications.show({
            message: t("modals.edit_torrent.error_update"),
            color: "red",
          });
        },
      }
    ...
    <>
      {props.opened && (
        <SaveCancelModal
          ...
          onSave={onSave}
          centered
          title={t("modals.edit_torrent.title")}
          mih="25rem"
        >
          ...
          <Grid align="center">
            ...
            <Grid.Col span={8}>
              <Checkbox
                my="sm"
                label={t("modals.edit_torrent.honor_session_limits")}
            ...
            <Grid.Col span={4}>
              {rpcVersion >= 18 && (
                <Checkbox
                  my="sm"
                  label={t("modals.edit_torrent.sequential_download")}
            ...
            <Grid.Col span={8}>
              <Checkbox
                label={t("modals.edit_torrent.max_download_speed")}
            ...
            <Grid.Col span={2}>{t("modals.edit_torrent.kb_s")}</Grid.Col>
            <Grid.Col span={8}>
              <Checkbox
                label={t("modals.edit_torrent.max_upload_speed")}
            ...
            <Grid.Col span={2}>{t("modals.edit_torrent.kb_s")}</Grid.Col>
            <Grid.Col span={8}>{t("modals.edit_torrent.peer_limit")}</Grid.Col>
            <Grid.Col span={2}>
            ...
            <Grid.Col span={8}>
              <Checkbox
                label={t("modals.edit_torrent.seed_ratio")}
            ...
            <Grid.Col span={8}>
              <Checkbox
                label={t("modals.edit_torrent.stop_seeding_inactive")}
            ...
            <Grid.Col span={2}>{t("modals.edit_torrent.minutes")}</Grid.Col>
          </Grid>
        </SaveCancelModal>
      )}
    </>
