    ...
    (prefixes: string[]) => {
      try {
        ...
        setFieldError(
          ...
          t("modals.interface.invalid_regex")
        );
      }
    },
    ...
    <Tabs defaultValue="appearance" orientation="vertical" mih="29rem">
      <Tabs.List>
        <Tabs.Tab value="appearance" p="lg">
          {t("modals.interface.tab_appearance")}
        </Tabs.Tab>
        <Tabs.Tab value="downloads" p="lg">
          {t("modals.interface.tab_downloads")}
        </Tabs.Tab>
        <Tabs.Tab value="miscellaneous" p="lg">
          {t("modals.interface.tab_miscellaneous")}
        </Tabs.Tab>
      </Tabs.List>
      <Tabs.Panel value="appearance" p="lg">
        <Grid align="center">
          ...
          <Grid.Col span={6}>{t("modals.interface.text_color")}</Grid.Col>
          <Grid.Col span={6}>
            <ColorChooser
          ...
          <Grid.Col span={6}>{t("modals.interface.progress_bars")}</Grid.Col>
          <Grid.Col span={3}>
            <Checkbox
          ...
          <Grid.Col>
            <Checkbox
              label={t("modals.interface.custom_date_time_format")}
              mt="lg"
      ...
      <Tabs.Panel value="downloads" p="lg">
        <Grid align="center">
          <Grid.Col>
            <Checkbox
              label={t("modals.interface.skip_add_dialog")}
          ...
          <Grid.Col span={6}>
            {t("modals.interface.new_torrent_start")}
          </Grid.Col>
          <Grid.Col span={6}>
            <NativeSelect
          ...
          <Grid.Col span={6}>
            {t("modals.interface.new_torrent_priority")}
          </Grid.Col>
          <Grid.Col span={6}>
            <NativeSelect
          ...
          <Grid.Col>
            <Checkbox
              label={t("modals.interface.sort_download_dirs")}
              my="lg"
          ...
          <Grid.Col span={9}>
            {t("modals.interface.max_saved_download_dirs")}
          </Grid.Col>
          <Grid.Col span={3}>
            <NumberInput
              min={1}
          ...
          <Grid.Col>
            <Textarea
              minRows={6}
              label={t("modals.interface.preconfigured_dirs")}
          ...
          <Grid.Col>
            <MultiSelect
              ...
              label={
                <Box>
                  <span>{t("modals.interface.preconfigured_labels")}</span>
                  <HoverCard width={280} shadow="md">
                    ...
                    <HoverCard.Dropdown>
                      <Text size="sm">
                        {t("modals.interface.preconfigured_labels_tooltip")}
                      </Text>
                    </HoverCard.Dropdown>
                  </HoverCard>
                </Box>
              ...
              getCreateLabel={(query) =>
                t("modals.interface.add_label", { query })
              }
              onCreate={(query) => {
      ...
      <Tabs.Panel value="miscellaneous" p="lg">
        <Grid align="center">
          <Grid.Col span={8}>
            {t("modals.interface.remove_torrent_delete_data")}
          </Grid.Col>
          <Grid.Col span={4}>
            <NativeSelect
          ...
          <Grid.Col>
            <MultiSelect
              ...
              label={
                <Box>
                  <span>{t("modals.interface.ignored_tracker_prefixes")}</span>
                  <HoverCard width={380} shadow="md">
                    ...
                    <HoverCard.Dropdown>
                      <Text size="sm">
                        {t("modals.interface.ignored_tracker_prefixes_tooltip")}
                      </Text>
                    </HoverCard.Dropdown>
                  </HoverCard>
                </Box>
              ...
              getCreateLabel={(query) =>
                t("modals.interface.add_prefix", { query })
              }
              onCreate={(query) => {
          ...
          <Grid.Col>
            <Textarea
              minRows={6}
              label={t("modals.interface.default_tracker_list")}
