    ...
    <HkModal opened={opened} onClose={close} size="lg" centered p="lg">
      ...
      <Flex gap="md" align="center">
        ...
        <Grid>
          ...
          <Grid.Col span={4}>{t("version.build_date")}</Grid.Col>
          <Grid.Col span={8}>
            {new Date(appVersion.buildDate).toLocaleString()}
          </Grid.Col>
          <Grid.Col span={4}>{t("version.source_code")}</Grid.Col>
          <Grid.Col span={8}>
      ...
      <Divider px="sm" my="xl" />
      <Text align="center">{t("version.powered_by")}</Text>
      <Flex justify="center">
